  ...
  <table class="table table-hover table-condensed">
    ...
    @if($tampil->kategori=='lain')
      <tr>
        ...
        @endif
        <td>{{$tampil->name}}</td>
        <td class="text-center"><button class="btn btn-info"><span class="glyphicon glyphicon-eye-open"></span></button></td>
        <td><a href="{{url('/dashboard/edit-article/')}}/{{$tampil->id}}"><button class="btn btn-info">Edit</button></a></td>
