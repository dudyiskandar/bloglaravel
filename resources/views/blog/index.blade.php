...
@section('content')
	...
	@foreach($article as $tampil)
			<div class="panel panel-default">
				...
				<div class="row foot">
					<ul class="foot">
						<li><a href="{{('kursus-web/read/article')}}/{{$tampil->judul}}/{{$tampil->id}}#comment"><span class="glyphicon glyphicon-comment"></span> Comment(10)</a></li>
	...
	@endforeach
			<center><ul class="actions pagination">
